...
This a Simple Project Based on a NUWE Challenge, you can use this project as a reference to learn the basics of **Backend Development** with a different framework than usual [ExpressJS](https://expressjs.com/) in this case using [Fastify](https://fastify.dev/) to mount a web service

This is not a Course but i will expose some useful information if you to want build and test this project with your own [MongoDB](https://mongodb.com/) database
